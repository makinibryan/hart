...
import {
    ...
    MountainSixDaysHikeChogoriaRouteDownNaroMoruComponent,
    AllSafarisComponent,
    ...
    MountainSixDaysFiveNightsTrekkingSafariComponent,
    MountainFourDaysMountElgonTourComponent,
    BeachSixDaysBlissKenyaBeachAndWildlifeTourComponent,
    SafariThreeDaysMaasaiMaraEntumotoTentedCampComponent, 
    SafariFiveDaysMasaiMaraLakeNakuruAndLakeBaringoBogoriaComponent,
    SafariSevenDaysMaasaiMaraLakeNakuruLakeNaivashaAndAmboseliNationalParkComponent
} from './components';
...
const routes: Routes = [
    ...
    },
    {
     ...
     {
         path: 'six-days-mountain-hike-chogoria-route-down-naro-moru',
         component: MountainSixDaysHikeChogoriaRouteDownNaroMoruComponent
     },
     {
         path: 'six-days-five-nights-mountain-trekking-safari',
         component: MountainSixDaysFiveNightsTrekkingSafariComponent
     }, {
         path: 'four-days-mount-elgon-tour',
         component: MountainFourDaysMountElgonTourComponent
     },
    {
        path: 'safaris',
    ...
    },
    {
        ...
        path: 'six-days-of-bliss-at-the-kenyan-beach-and-wildlife-tour',
        component: BeachSixDaysBlissKenyaBeachAndWildlifeTourComponent
    },
    {
        path: 'safari-three-days-maasai-mara-entumoto-tented-camp',
        component: SafariThreeDaysMaasaiMaraEntumotoTentedCampComponent
    },
    {
        path: 'safari-five-days-masai-mara-lake-nakuru-and-lake-baringo-bogoria',
        component: SafariFiveDaysMasaiMaraLakeNakuruAndLakeBaringoBogoriaComponent
    },
    {
        path: 'safari-seven-days-maasai-mara-lake-nakuru-lake-naivasha-and-amboseli-national-park',
        component: SafariSevenDaysMaasaiMaraLakeNakuruLakeNaivashaAndAmboseliNationalParkComponent
    }
];
